...
WANDB_MODE=offline uv run main.py train +experiment=species_detector paths.data_dir=$STORAGE paths.results_dir=$RESULTS_DIR paths.checkpoint_dir=$CKPT_DIR model_name=silly-byte scope=SO_UK seed=8 trainer.max_epochs=400 model.clf_learning_rate=0.1 model.lamdba=0.01 model.attn_learning_rate=0.0005 model.attn_weight_decay=0.001
WANDB_MODE=offline uv run main.py train +experiment=species_detector paths.data_dir=$STORAGE paths.results_dir=$RESULTS_DIR paths.checkpoint_dir=$CKPT_DIR model_name=meek-zebra scope=SO_UK seed=16 trainer.max_epochs=400 model.clf_learning_rate=0.1 model.lamdba=0.01 model.attn_learning_rate=0.0005 model.attn_weight_decay=0.001
WANDB_MODE=offline uv run main.py train +experiment=species_detector paths.data_dir=$STORAGE paths.results_dir=$RESULTS_DIR paths.checkpoint_dir=$CKPT_DIR model_name=rude-money scope=SO_UK seed=24 trainer.max_epochs=400 model.clf_learning_rate=0.1 model.lamdba=0.01 model.attn_learning_rate=0.0005 model.attn_weight_decay=0.001

# |       | model   | scope     |   epoch |   clf_learning_rate |   lamdba |   attn_learning_rate |   attn_weight_decay |    auROC |        AP |    score |
# |------:|:--------|:----------|--------:|--------------------:|---------:|---------------------:|--------------------:|---------:|----------:|---------:|
# | 13567 | vae     | SO_EC     |    1749 |                0.1  |     0.01 |               0.001  |               0.001 | 0.809463 | 0.197051  | 1.01039  |
WANDB_MODE=offline uv run main.py train +experiment=species_detector paths.data_dir=$STORAGE paths.results_dir=$RESULTS_DIR paths.checkpoint_dir=$CKPT_DIR model_name=silly-byte scope=SO_EC seed=8 trainer.max_epochs=1750 model.clf_learning_rate=0.1 model.lamdba=0.01 model.attn_learning_rate=0.001 model.attn_weight_decay=0.001
WANDB_MODE=offline uv run main.py train +experiment=species_detector paths.data_dir=$STORAGE paths.results_dir=$RESULTS_DIR paths.checkpoint_dir=$CKPT_DIR model_name=meek-zebra scope=SO_EC seed=16 trainer.max_epochs=1750 model.clf_learning_rate=0.1 model.lamdba=0.01 model.attn_learning_rate=0.001 model.attn_weight_decay=0.001
WANDB_MODE=offline uv run main.py train +experiment=species_detector paths.data_dir=$STORAGE paths.results_dir=$RESULTS_DIR paths.checkpoint_dir=$CKPT_DIR model_name=rude-money scope=SO_EC seed=24 trainer.max_epochs=1750 model.clf_learning_rate=0.1 model.lamdba=0.01 model.attn_learning_rate=0.001 model.attn_weight_decay=0.001
...
WANDB_MODE=offline uv run main.py train +experiment=species_detector paths.data_dir=$STORAGE paths.results_dir=$RESULTS_DIR paths.checkpoint_dir=$CKPT_DIR model_name=tan-ohio scope=SO_UK seed=8 trainer.max_epochs=800 model.clf_learning_rate=0.1 model.lamdba=0.01 model.attn_learning_rate=0.0005 model.attn_weight_decay=0.01
WANDB_MODE=offline uv run main.py train +experiment=species_detector paths.data_dir=$STORAGE paths.results_dir=$RESULTS_DIR paths.checkpoint_dir=$CKPT_DIR model_name=small-peru scope=SO_UK seed=16 trainer.max_epochs=800 model.clf_learning_rate=0.1 model.lamdba=0.01 model.attn_learning_rate=0.0005 model.attn_weight_decay=0.01
WANDB_MODE=offline uv run main.py train +experiment=species_detector paths.data_dir=$STORAGE paths.results_dir=$RESULTS_DIR paths.checkpoint_dir=$CKPT_DIR model_name=brave-vincent scope=SO_UK seed=24 trainer.max_epochs=800 model.clf_learning_rate=0.1 model.lamdba=0.01 model.attn_learning_rate=0.0005 model.attn_weight_decay=0.01

# |       | model   | scope     |   epoch |   clf_learning_rate |   lamdba |   attn_learning_rate |   attn_weight_decay |    auROC |        AP |    score |
# |------:|:--------|:----------|--------:|--------------------:|---------:|---------------------:|--------------------:|---------:|----------:|---------:|
# |  5174 | sivae   | SO_EC     |    1249 |                0.1  |     0.01 |               0.001  |               0.001 | 0.832921 | 0.271675  | 1.10853  |
WANDB_MODE=offline uv run main.py train +experiment=species_detector paths.data_dir=$STORAGE paths.results_dir=$RESULTS_DIR paths.checkpoint_dir=$CKPT_DIR model_name=tan-ohio scope=SO_EC seed=8 trainer.max_epochs=1250 model.clf_learning_rate=0.1 model.lamdba=0.01 model.attn_learning_rate=0.001 model.attn_weight_decay=0.001
WANDB_MODE=offline uv run main.py train +experiment=species_detector paths.data_dir=$STORAGE paths.results_dir=$RESULTS_DIR paths.checkpoint_dir=$CKPT_DIR model_name=small-peru scope=SO_EC seed=16 trainer.max_epochs=1250 model.clf_learning_rate=0.1 model.lamdba=0.01 model.attn_learning_rate=0.001 model.attn_weight_decay=0.001
